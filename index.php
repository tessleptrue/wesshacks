...
echo json_encode([
    ...
    'endpoints' => [
        ...
        [
            ...
            'methods' => ['GET', 'POST', 'DELETE'],
            'description' => 'Manage saved houses for users',
            'params' => [
                'GET' => [
                    'Get all houses saved by the current user (authentication required)'
                ],
                'POST' => [
                    'house_address' => 'Address of the house to save (required)'
                ],
                'DELETE' => [
                    'house' => 'Address of the house to unsave (required)'
                ]
            ],
